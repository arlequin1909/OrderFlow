...
public sealed class RabbitMqOptions
{
    ...
    /// <summary>Queue consumed for order-created events.</summary>
    public string OrderCreatedQueue { get; set; } = "order-created";

    /// <summary>Queue published to when stock is reserved successfully.</summary>
    public string StockReservedQueue { get; set; } = "stock-reserved";

    /// <summary>Queue published to when stock could not be reserved.</summary>
