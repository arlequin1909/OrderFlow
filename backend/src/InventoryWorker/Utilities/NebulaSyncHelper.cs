...
namespace InventoryWorker.Utilities;
...
///
/// OrdersApi keeps an identical copy in its own project — the two services no longer share a
/// common library (see README "Architecture decisions"), so this class must be kept in sync
/// by hand across both. It performs no I/O — a pure, in-process helper.
/// </summary>
